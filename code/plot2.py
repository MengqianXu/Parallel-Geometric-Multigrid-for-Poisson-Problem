...
for i in range(1, len(argv)):
	...
	if N != 1 :
		...
		titre = "Vraie solution pour F1 avec N = " + str(N)
		axe = plt.axes(projection ='3d', title = titre)
		axe.plot_surface(tabX, tabY, U1)
		plt.savefig(dossier + titre + ".png")
		plt.show()

		titre = "Solution directe pour F1 avec N = " + str(N)
		axe = plt.axes(projection ='3d', title = titre)
